...
signupForm.addEventListener('submit', function(event) {
  const firstNameInput = signupForm.elements.fname.trim();
  const lastNameInput = signupForm.elements.lname.trim();
  const usernameInput = signupForm.elements.username.trim();
